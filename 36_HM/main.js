window.addEventListener("load", async () => {
    ...
    const request = $fetch("https://60ab362d5a4de40017cc987a.mockapi.io/comments");
    ...
    form.addEventListener("submit", async (event) => {
        ...
        if (isFormValid) {
            ...
            const newComment = await $fetch("https://60ab362d5a4de40017cc987a.mockapi.io/comments/" + id, "PUT", personNewInput);
